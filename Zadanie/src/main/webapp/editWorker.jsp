    ...
    <div class="row">
        <div class="col-md-offset-2 col-md-7">
            ...
            <div class="col-md-offset-3 col-md-9">
                <h2>Please adding Worker</h2>
                <form action="servlet.do" method="post" >
                    <input type="hidden" name="command" value="editWorker"/>
                    <input type="hidden" name="workerId" value="<%= request.getParameter("workerId") %>"/>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success btn-block"><h4>Edit Worker</h4></button>
                    </div>
