    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <c:forEach items="${department}" var="department">
            ...
            <td></td>
            <td><a class="btn btn-success" href="editDepartment.jsp?departmentId=${department.getDepartmentId()}" >Edit</a></td>
            <td><a class="btn btn-success" href="servlet.do?command=deleteDepartment&departmentId=${department.getDepartmentId()}" >Delete</a></td>
